    ...
    return (
      <div className="AboutMe">
        <div className="AboutMe-content">
          ...
          <p className="AboutMe-content-paragraph">
          ...
          <p className="AboutMe-content-paragraph">
            ...
            Lately, i have studied a <a href="https://www.cice.es/master-en-desarrollo-de-videojuegos-realidad-virtual-unity/" className="AboutMe-content-paragraph-cicelink">Master on Unity Development in CICE</a>,
            that gave me all the insights I needed to start developing games as well as prepared me to get the <a href="https://certification.unity.com/products/certified-developer" className="AboutMe-content-paragraph-unitylink">Unity Certified Developer</a> title.
          </p>
          <p className="AboutMe-content-paragraph">
