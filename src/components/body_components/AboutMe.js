...
import img_raul from '../../images/AboutMeRaul.jpg';
import './AboutMe.css';
    ...
    return (
      <div className="AboutMe">
        <div className="AboutMe-content">
          <h1 className="AboutMe-content-title">Hi! My name is Raúl and I live in Alcobendas, Madrid.</h1>
          <div className="AboutMe-content-container">
            <img src={img_raul} className="AboutMe-content-container-photo" alt="Raúl"/>
            <div className="AboutMe-content-container-textContainer">
              <p className="AboutMe-content-container-textContainer-paragraph">
              ...
              <p className="AboutMe-content-container-textContainer-paragraph">
                ...
                Lately, i have studied a <a href="https://www.cice.es/master-en-desarrollo-de-videojuegos-realidad-virtual-unity/" className="AboutMe-content-container-textContainer-paragraph-cicelink">Master on Unity Development in CICE</a>,
                that gave me all the insights I needed to start developing games as well as prepared me to get the <a href="https://certification.unity.com/products/certified-developer" className="AboutMe-content-container-textContainer-paragraph-unitylink">Unity Certified Developer</a> title.
              </p>
              <p className="AboutMe-content-container-textContainer-paragraph">
